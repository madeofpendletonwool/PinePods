...
pub fn export_options() -> Html {
    ...
    html! {
        <div class="p-4"> // You can adjust the padding as needed
            ...
            <button onclick={onclick} class="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
