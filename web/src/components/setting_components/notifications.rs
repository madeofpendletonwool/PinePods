...
pub fn notification_settings() -> Html {
    ...
    html! {
        <form onsubmit={on_submit}>
            ...
            <div class="settings-row">
                <div><div class="settings-row-label">{&i18n_enable_notifications}</div></div>
                <div class="settings-row-control">
                    <label class="toggle">
                        <input
                            type="checkbox"
...

            {
                if *platform == "ntfy" {
                    html! {
                        <>
                            <div class="settings-row">
                                <div><div class="settings-row-label">{&i18n_ntfy_topic}</div></div>
                                <div class="settings-row-control">
                                    <input
                                        type="text"
                            ...
                            <div class="settings-row">
                                <div><div class="settings-row-label">{&i18n_ntfy_server_url}</div></div>
                                <div class="settings-row-control">
                                    <input
                                        type="text"
                            ...
                            <div class="settings-subsection-title">{&i18n_authentication_optional}</div>
                            <div class="settings-row">
                                <div>
                                    <div class="settings-row-label">{&i18n_username}</div>
                                    <div class="settings-row-desc">{&i18n_username_password_or_token}</div>
                                </div>
                                <div class="settings-row-control">
                                    <input
                                        type="text"
                            ...
                            <div class="settings-row">
                                <div><div class="settings-row-label">{&i18n_access_token}</div></div>
                                <div class="settings-row-control">
                                    <input
                                        type="password"
                    ...
                    html! {
                        <>
                            <div class="settings-row">
                                <div><div class="settings-row-label">{&i18n_gotify_server_url}</div></div>
                                <div class="settings-row-control">
                                    <input
                                        type="text"
                            ...
                            <div class="settings-row">
                                <div><div class="settings-row-label">{&i18n_gotify_app_token}</div></div>
                                <div class="settings-row-control">
                                    <input
                                        type="text"
                                ...
                                <div class="settings-row-control">
                                    <div class="notification-platform-tabs">
                                        <button
                                            ...
                                            onclick={let http_method = http_method.clone(); Callback::from(move |_| { http_method.set("POST".to_string()); })}
                                        >{"POST"}</button>
                                        <button
                                            type="button"
                                            class={if *http_method == "GET" { "notification-platform-tab active" } else { "notification-platform-tab" }}
                                            onclick={let http_method = http_method.clone(); Callback::from(move |_| { http_method.set("GET".to_string()); })}
                                        >{"GET"}</button>
                                    </div>
                                </div>
                            </div>
