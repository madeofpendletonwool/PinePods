                ...
                <div class="rounded-xl theme-dropdown-arrow overflow-hidden">
                {
                    if *active_tab == "user" {
                        ...
                        <div id="accordion-collapse" data-accordion="collapse" class="bg-custom-light">
                            ...
                            <AccordionItem title="Connect Nextcloud/Gpodder Podcast Sync" content={html!{ <setting_components::nextcloud_options::SyncOptions /> }} position={AccordionItemPosition::Middle}/>
