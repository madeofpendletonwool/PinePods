                                    ...
                                    <>
                                        ...
                                        <div class="large-card col-span-1 md:col-span-3">
                                            ...
                                            <div class="large-card-content flex flex-col space-y-2">
                                                <a href="https://www.pinepods.online" target="_blank" class="large-card-button focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">{"Pinepods Documentation"}</a>
