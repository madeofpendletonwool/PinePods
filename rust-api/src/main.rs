...
fn create_data_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/clear_queue", post(handlers::podcasts::clear_all_queue))
        ...
        .route("/podcast_download_summary/{user_id}", get(handlers::podcasts::get_podcast_download_summary))
        .route("/podcast_downloads_paged/{user_id}/{podcast_id}", get(handlers::podcasts::get_podcast_downloads_paged))
        ...
        .route("/get_user_shared_links/{user_id}", get(handlers::settings::get_user_shared_links))
        .route("/delete_shared_link", delete(handlers::settings::delete_shared_link))
        .route("/extend_shared_link", put(handlers::settings::extend_shared_link))
        ...
        .route("/user/custom_themes/{user_id}", get(handlers::settings::get_custom_themes))
        .route("/user/custom_themes", post(handlers::settings::create_custom_theme))
        .route("/user/custom_themes", delete(handlers::settings::delete_custom_theme))
