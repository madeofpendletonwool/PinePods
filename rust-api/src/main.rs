...
fn create_data_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/homepage/trending", get(handlers::homepage::get_trending))
        .route("/homepage/trending/invalidate", post(handlers::homepage::invalidate_trending_cache))
        .route("/homepage/recommended", get(handlers::homepage::get_recommended))
        .route("/homepage/recommended/generate", post(handlers::homepage::generate_recommendations))
