...
class PodcastControls:
    ...
    def __init__(self, page, current_episode, go_home=None, parsed_audio_url=None, parsed_title=None, active_user=None):
        active_user = 'test'

        class Object(active_user):
            pass

        active_user = Object()
        active_user.main_color = "Blue"
